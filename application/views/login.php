...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="<?=base_URL()?>index.php/tampil/do_login" method="post">
        <h2 class="form-signin-heading">Yu mas bi login...!</h2>
        ...
        <button class="btn btn-large btn-primary" type="submit">Mlebu</button>
      </form>
