...
insert  into `admin`(`id`,`u`,`p`,`nama`,`email`,`level`) values (1,'admin','21232f297a57a5a743894a0e4a801fc3','Nur Akhwan','akhwan90@gmail.com','1');
...
insert  into `agenda`(`id`,`tgl`,`ket`,`tempat`) values (1,'2013-03-16','konsultasi Dosen','STMIK El Rahma'),(2,'2017-05-01','Libur Panjang','Rumah');
...
insert  into `berita_komen`(`id`,`id_berita`,`nama`,`email`,`komentar`,`tgl`) values (1,16,'Akhwan','akhwan08@yahoo.com','yak.. sip sekali..','2013-01-13 19:44:49');
...
insert  into `carousel`(`id`,`foto`,`judul`,`ket`) values (2,'1.jpg','RVP','He say : Yess... I have found an excellent website'),(3,'2.jpg','Wazza and Clev','Wazza and Clev is agree that this website is very good'),(4,'3.jpg','Sir Alex Ferguson','Sir Alex say that this website is bagus..'),(5,'1._murni_shuffle_20_.PNG','Gambar','Keterangan Gambar');
...
insert  into `data_guru`(`id`,`nama`,`nip`,`mapel`,`jk`,`alamat`,`foto`) values (1,'Nur Akhwan, S.Pd.Kom','19900326 201601 1 002','Komputer','L','Sumoroto, Sidoharjo, Samigaluh, Kulon Progo','');
...
insert  into `data_siswa`(`id`,`nama`,`nis`,`kelas`,`jk`,`alamat`,`foto`,`pass`) values (1,'NUr Akhwan','12090672','6','L','Sumoroto, Sidoharjo, Samigaluh, Kulon Progo','','21232f297a57a5a743894a0e4a801fc3'),(2,'Akhwan Noor','19900326','2','L','Sidoharjo','','21232f297a57a5a743894a0e4a801fc3'),(3,'Akhwan Januzaj','19950207','3','L','Sir Matt Busby Way','','21232f297a57a5a743894a0e4a801fc3');
...
insert  into `galeri`(`id`,`id_album`,`file`,`ket`) values (1,1,'Desert.jpg','Desert'),(2,1,'Koala.jpg','Koala'),(3,1,'Penguins.jpg','Penguins'),(4,1,'Light_house.jpg','Light House'),(6,1,'gizi_nasi_goreng5.PNG','Fotoo');
...
insert  into `galeri_album`(`id`,`nama`) values (1,'foto sekolah');
...
insert  into `haldep`(`isi`,`id`) values ('<p>\r\n <i><b>Assalamu&#39;alaikum warah matullohi wabarakatuh</b></i></p>\r\n<p>\r\n Selamat datang di website Sekolah Dasar Negeri Sidareja, Cilacap, Jawa Tengah. Mudah-mudahan dengan ad<img alt=\"smiley\" height=\"20\" src=\"http://localhost/sekolah/assets/grocery_crud/texteditor/ckeditor/plugins/smiley/images/regular_smile.gif\" title=\"smiley\" width=\"20\" />anya media informasi websie ini dapat digunakan sebagai media tukar menukar informasi antara SD Negeri Sidareja, dengan masyarakat. fff</p>\r\n<p>\r\n <i><b>Wassalamu&#39;alaikum warah matullohi wabarakatuh</b></i></p>\r\n',1);
...
insert  into `interaktif`(`id`,`ket`,`link`) values (1,'Berita','http://localhost/sekolah/tampil/blog');
...
insert  into `kat`(`id`,`nama`) values (10,'Manchester United'),(11,'Juventus');
...
insert  into `link`(`id`,`nama`,`alamat`) values (1,'Kemdiknas','http://kemdiknas.go.id/'),(2,'Praktisi Komputer','http://praktisikomputer.com');
...
insert  into `pesan`(`id`,`nama`,`email`,`pesan`,`tgl`) values (1,'Nur Akhwan','akhwan90@gmail.com','Dicoba lagi','2012-11-20 10:13:37'),(2,'SMK Negeri 1 Pangkalan Banteng','akhwan90@gmail.com','super sekali','2012-11-20 10:13:49'),(4,'Akhwan','akhwan90@gmail.com','mau kirim program, bagaimana pesannya..?','2012-12-30 18:13:38');
...
insert  into `poll`(`id`,`tanya`,`op_1`,`op_2`,`op_3`,`op_4`,`j_1`,`j_2`,`j_3`,`j_4`) values (1,'Bagaimanakah design website ini ?','Sangat Bagus','Bagus','Bagus Sekali','Tidak Jelek',8,2,3,1);
...
insert  into `profil`(`id`,`judul`,`isi`) values (1,'Sejarah','Maaf, pemiarsa...<br>\r\nBelum ada konten..ssss'),(2,'Visi Misi','Maaf pemiarsa..<div>Belum Ada konten :)</div>');
